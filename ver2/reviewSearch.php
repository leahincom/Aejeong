...
$name=$row1['ItemName'];
$result=mysqli_query($db,"SELECT * FROM Reviews WHERE ItemName='$name' AND ((Advantage like '%$searchText%') OR (Weakness like '%$searchText%') OR (Etc like '%$searchText%')) ORDER BY Date DESC");
?>
